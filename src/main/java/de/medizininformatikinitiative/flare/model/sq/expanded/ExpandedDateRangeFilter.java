...
public record ExpandedDateRangeFilter(String searchParameter, LocalDate lowerBound, LocalDate upperBound, String referenceSearchParam)
    ...
    public QueryParams toParams() {
        return QueryParams.EMPTY
                .appendParam(searchParameter, GREATER_EQUAL, lowerBound, referenceSearchParam)
                .appendParam(searchParameter, LESS_EQUAL, upperBound, referenceSearchParam);
    }
}
